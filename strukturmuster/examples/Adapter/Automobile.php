...
class AutomobileException extends \Exception {}

class IgniteException extends AutomobileException {}
...
class Automobile {
    ...
    public function ignite() {
        if ($this->keyPluggedIn !== true) {
            throw new IgniteException('Schl�ssel steckt nicht.');
        }
        $this->ignited = true;
    }
    ...
    public function drive($direction, $miles) {
        if ($this->ignited !== true) {
            throw new AutomobileException('Z�ndung ist nicht an.');
        }
